...
?>
	...
	<head>
		...
		<title>Laptop Rental Portal |Admin Manage Laptops </title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Manage Laptops</h2>
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {				?>
													<tr>
														...
														<td><?php echo htmlentities($result->LaptopTitle); ?></td>
														...
														<td>
															<a href="edit-laptop.php?id=<?php echo $result->id; ?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;

        ...
        <div class="col-sm-9 col-md-10" style="margin-top: 15px;">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@rentalaptop.co.ke">info@rentalaptop.co.ke</a>
            </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Call Us: </p>
              <a href="tel:+254708412753">+254 708 412 753</a>
            </div>
    ...
    <div class="container">
      ...
      <div class="header_wrap">
        ...
        <div class="header_search">
          ...
          <form action="post" method="get" id="header-search-form">
